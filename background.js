// Background service worker for Explain This Page extension v2.2
...
chrome.action.onClicked.addListener((tab) => {
  ...
  }).catch(error => console.error('Error triggering page explanation:', error));
});
...
console.log('Explain This Page background service worker loaded (v2.2)');
